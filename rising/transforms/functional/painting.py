...
def local_pixel_shuffle(data: torch.Tensor, n: int = -1) -> torch.Tensor:
    ...
    for b in range(batch_size):
        for _ in range(n):
            ...
            block_size_x = torch.randint(2, img_rows // 10, (1,))
            block_size_y = torch.randint(2, img_cols // 10, (1,))
            block_size_z = torch.randint(2, img_deps // 10, (1,))
